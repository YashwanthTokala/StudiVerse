    ...
    return (
        <div>
            <div className="container my-3">
                ...
                <div id="carouselExample" className="carousel slide" data-bs-ride="carousel" data-bs-interval="2500">
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img src="/hack.png" className="d-block w-100" alt="event-1" style={{ height: '400px', objectFit: 'cover' }} onClick={handleImageClick} />
                        </div>
                        <div className="carousel-item">
                            <img src="/tech5.jpeg" className="d-block w-100" alt="event-2" style={{ height: '400px', objectFit: 'cover' }} onClick={handleImageClick} />
                        </div>
                        <div className="carousel-item">
                            <img src="/fest1.jpeg" className="d-block w-100" alt="event-3" style={{ height: '400px', objectFit: 'cover' }} onClick={handleImageClick} />
                        </div>
                    </div>
                ...
                <h2 className='my-2'>Hackathons</h2>
