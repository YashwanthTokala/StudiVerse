    ...
    return (
        <div>
            <div className="container my-3">
                ...
                <div id="carouselExample" className="carousel slide" data-bs-ride="carousel" data-bs-interval="2500">
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img src="/fest1.jpeg" className="d-block w-100" alt="event-1" style={{ height: '400px', objectFit: 'cover' }} onClick={handleImageClick} />
                        </div>
                        <div className="carousel-item">
                            <img src="/tech5.jpeg" className="d-block w-100" alt="event-2" style={{ height: '400px', objectFit: 'cover' }} onClick={handleImageClick} />
                        </div>
                        <div className="carousel-item">
                ...
                <h2 className='my-2'>Cultural Fests</h2>
                ...
                <h2 className='my-2'>Fest Updates</h2>
                <div className="container">
                    <div className={`row ${containerClass}`}>
                            ...
                            <div className="col-md-4" key={index}>
                                <div className={`card my-3 shadow-sm ${cardClass}`} style={{ width: '18rem' }}>
                                    ...
                                    <div className="card-body">
                                        <h5 className="card-title">{item.title}</h5>
                                        <p>Date: {item.date}</p>
                                        <button onClick={handleImageClick} className={`btn btn-success btn-sm ${buttonClass}`}>PreRegister now</button>
                                    </div>
                                </div>
                            </div>
                        ))}
